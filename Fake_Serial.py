...
'''The idea is that this class is the fake serial class for the 
simulator that will allow us to bypass the serial port and also will be 
used for all the memory address swaps we need 
for both potentiostat versions
'''
...
#from main_copy import setup_parser as sp
#import msvcrt

#making a logging file
logging.basicConfig(filename='Fake_Serial.log', filemode='a', level=logging.DEBUG, format='%(asctime)s, %(levelname)s, %(message)s')
logging.info(" ---------------------- root --------------------------------")
