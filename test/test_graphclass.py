...
"""
NOTE that several spike tests and concept designs  have been commented out to ease for testing
"""
...
class graphtest(unittest.TestCase):
    ...
    '''
    def test30(self):
        ''creating a 5 column array CSV file called Extra for simulation purposes. 
        Alternate columns are sinx * a factor for up and down transitions/transpositions ''
        filename = "EXTRA.csv"
        NEWLINE = "\n"
        myfile = open(filename, "w")
        x = arange(0,2*pi,0.01)
